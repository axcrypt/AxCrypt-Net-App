...
using Platform = AxCrypt.Core.Runtime.Platform;
...
public class FontLoader : IDisposable
{
    ...
    public FontLoader()
    {
        ...
        //AddFontFromResource(_privateFontCollection1, Resource.OpenSans_Light);
        //AddFontFromResource(_privateFontCollection1, Resource.OpenSans_Regular);
        //AddFontFromResource(_privateFontCollection1, Resource.OpenSans_Semibold);
        //AddFontFromResource(_privateFontCollection2, Resource.OpenSans_Bold);
    }
