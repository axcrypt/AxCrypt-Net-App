...
namespace AxCrypt.Core.Test.CryptoValidation
{
    ...
    public class TestSha256
    {
        ...
        public void TestInformalAbc()
        {
            ...
            Assert.That(actual, Is.EquivalentTo("BA7816BF 8F01CFEA 414140DE 5DAE2223 B00361A3 96177A9C B410FF61 F20015AD".FromArgb()));
        }
        ...
        public void TestInformalLongerText()
        {
            ...
            byte[] actual;
            actual = hash.ComputeHash(bytes);
            Assert.That(actual, Is.EquivalentTo("248D6A61 D20638B8 E5C02693 0C3E6039 A33CE459 64FF2167 F6ECEDD4 19DB06C1".FromArgb()));
        }
        ...
        public void TestInformalMillionA()
        {
            ...
            byte[] actual;
            actual = hash.Hash();
            Assert.That(actual, Is.EquivalentTo("CDC76E5C 9914FB92 81A1C7E2 84D73E67 F1809A48 A497200E 046D39CC C7112CD0".FromArgb()));
        }
    }
}